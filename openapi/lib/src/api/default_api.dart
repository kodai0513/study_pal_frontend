...
class DefaultApi {
  ...
  Future<Response<WorkbookResp>> createApiV1WorkbooksPost({ 
    ...
    final _path = r'/api/v1/workbooks/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WorkbookListViewResp>> getWorkbooksByKeywordApiV1WorkbooksGet({ 
    String? keyword = '',
    ...
    WorkbookListViewResp? _responseData;
    ...
    return Response<WorkbookListViewResp>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [WorkbookListViewResp] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WorkbookListViewResp>> getWorkbooksForFavoritesApiV1WorkbooksFavoritesGet({ 
    String? nextPageToken,
    int? pageSize = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/workbooks/favorites';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [WorkbookListViewResp] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WorkbookListViewResp>> getWorkbooksForMeApiV1WorkbooksMeGet({ 
    String? nextPageToken,
    int? pageSize = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/workbooks/me';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TimelineViewResp>> indexApiV1TimelinesGet({ 
    ...
    final _path = r'/api/v1/timelines';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    TimelineViewResp? _responseData;
    ...
    return Response<TimelineViewResp>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
